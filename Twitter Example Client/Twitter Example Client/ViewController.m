...
- (void)viewDidLoad {
    ...
    [twitterClient authorizeUsingOAuthWithRequestTokenPath:@"request_token" userAuthorizationPath:@"authorize" callbackURL:[NSURL URLWithString:@"af-twitter://success"] accessTokenPath:@"access_token" accessMethod:@"POST" success:^(AFOAuth1Token *accessToken) {
